  ...
  try {
    ...
    const events = await Event.create([
      ...
      },
      {
        ...
        description: 'Global Conference of Meditation Leaders 2025 concluded greatly!! Join meditation leaders from around the world for this transformative conference featuring Master Chandra and other renowned meditation teachers.',
        type: 'conference',
