...
export async function POST(request: NextRequest) {
  console.log('\n========== TEACHER ENROLLMENT OTP REQUEST ==========');
  console.log('📥 Received send-otp request for teacher enrollment');
  ...
  try {
    ...
    console.log('🔍 Checking if already applied recently...');
    ...
    await createAndSendOtp({ email: normalizedEmail, purpose: 'teacher_enrollment' });
    ...
    console.error('\n❌ ERROR in teacher enrollment send-otp route:');
