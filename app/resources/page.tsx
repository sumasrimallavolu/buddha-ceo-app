      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[50vh] flex items-center overflow-hidden bg-slate-950">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 py-16">
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 max-w-5xl mx-auto mt-12">
                  ...
                  {testimonials.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                      {testimonials.map((testimonial) => (
                        <Card key={testimonial._id} className="border border-white/10 bg-gradient-to-br from-blue-500/5 to-blue-600/5 backdrop-blur-sm hover:border-blue-500/50 transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-500/10 overflow-hidden flex flex-col">
                          <CardHeader className="p-4 pb-2">
                            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-blue-500/20 to-blue-600/20 mb-4 flex-shrink-0">
                              <Quote className="h-7 w-7 text-blue-400" />
                            </div>
                            <CardTitle className="text-lg text-white line-clamp-2 leading-tight">{testimonial.content.name || 'Anonymous'}</CardTitle>
                            <div className="text-blue-400/90 font-medium text-sm mt-1 line-clamp-1">{testimonial.content.title || ''}</div>
                          ...
                          <CardContent className="p-4 pt-2 flex-grow">
                            <p className="text-slate-400 text-sm italic line-clamp-4">
                              "{testimonial.content.quote || 'Transformative experience through meditation.'}"
                            </p>
                          </CardContent>
                        </Card>
                      ))}
